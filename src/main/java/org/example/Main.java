...
public class Main {
    public static void main(String[] args) {
       ...
       System.out.println(list);
        ...
        humans.add(new Human("Egor", "Ivanov", 20));
        humans.add(new Human("Lida", "Karavaeva", 25));
        humans.add(new Human("Anna", "Lebedeva", 30));
        ...
        // HashSet и LinkedHashSet никак не сортируют, удаляют дубликаты
        // и хранят по-разному, поэтому не гарантируется.
        // TreeSet всегда сортирует и работает с дубликатами на основе порядка
